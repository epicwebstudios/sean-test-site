		...
		?>
            ...
            <tr>
                ...
                <? // Column output start ?>
                	...
                	<td>
						<? $image = img_url( '/news/'.$info['filename'], 75, 75 ); ?>
                        <a href="<? echo returnURL().'/uploads/news/'.$info['filename']; ?>" class="lightbox_img">
                        	<img src="<? echo $image; ?>" />
                        </a>
                    </td>
                
					<td>
                    	<a href="<? echo returnURL().'/uploads/news/'.$info['filename']; ?>" target="_blank">
