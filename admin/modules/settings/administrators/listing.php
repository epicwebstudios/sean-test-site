		...
		?>
            ...
            <tr <? if( $info['status'] == '0' ){ echo 'class="inactive"'; } ?>>
                ...
                <? // Column output start ?>
					...
					<td>
						<? echo $levels[$info['level']]; ?>
                    </td>
                    
                    <td>
                    	<? if( $info['status'] == '1' ){ echo '<b class="tc_green">Login Enabled</b>'; } ?>
                        <? if( $info['status'] == '0' ){ echo '<b class="tc_red">Login Disabled</b>'; } ?>
                        <? if( $info['status'] == '2' ){ echo '<b class="tc_yellow"><i>Account Locked</i></b>'; } ?>
                    </td>
                
					<td>
						<a href="?a=40&f_a=<? echo $info['id']; ?>">
                        	View Action Logs
                        </a>
                    </td>
