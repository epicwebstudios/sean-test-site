					...
					<td>
                        ...
                        <td>
                        	<?
								...
								$output = '<'.$elem.'>'.$link_types[$info['redirect_type']]['name'];
								...
								} else if( $link_types[$info['redirect_type']]['table'] ){
									
									$r_table 	= $link_types[$info['redirect_type']]['table'];
									$r_id 		= $link_types[$info['redirect_type']]['id'];
									$r_label	= $link_types[$info['redirect_type']]['label'];
									
									$record = mysql_fetch_assoc( mysql_query( "SELECT `".$r_label."` FROM `".$r_table."` WHERE `".$r_id."` = '".$info['page']."' LIMIT 1" ) );
