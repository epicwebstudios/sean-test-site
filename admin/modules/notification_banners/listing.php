					...
					<td>
						<?
							if( $info['date_start'] > 0 ){
								echo date( 'F j, Y', $info['date_start'] );
							} else {
                    ...
                    <td>
						<?
							if( $info['status'] == '1' ){
								...
								if( ($info['date_start'] > 0) && ($info['date_start'] > time()) ){
									echo '<b class="tc_green">Scheduled</b>';
								} else if( ($info['date_end'] > 0) && ($info['date_end'] < time()) ){
									echo '<b class="tc_red">Expired</b>';
								} else {
									echo '<b class="tc_green">Active / Enabled</b>';
								}
								
							} else {
								echo '<b class="tc_red">Inactive / Disabled</b>';
							}
						?>
                    </td>
