		...
		?>
            ...
            <tr>
                ...
                <? // Column output start ?>
                	...
                	<td>
						<? $image = img_url( '/gallery/'.$info['filename'], 75, 75 ); ?>
                        <a href="<? echo returnURL().'/uploads/gallery/'.$info['filename']; ?>" class="lightbox_img">
                        	<img src="<? echo $image; ?>" />
                        </a>
                    </td>
                
					<td>
                    	<a href="<? echo returnURL().'/uploads/gallery/'.$info['filename']; ?>" target="_blank">
							<b><? echo $info['filename']; ?></b>
                        </a>
                    </td>
