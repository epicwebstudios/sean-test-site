	...
	if( (isset($_POST['edit_sub'])) || (isset($_POST['add_sub'])) ){
		...
		// -- Set values
			...
			$values = array(
				...
				'thumb'			=> process_file( 'thumb', '/identity/logos/' ),
				'jpg'			=> process_file( 'jpg', '/identity/logos/' ),
				'png'			=> process_file( 'png', '/identity/logos/' ),
				'ai'			=> process_file( 'ai', '/identity/logos/' ),
				'psd'			=> process_file( 'psd', '/identity/logos/' ),
				'eps'			=> process_file( 'eps', '/identity/logos/' ),
				'pdf'			=> process_file( 'pdf', '/identity/logos/' ),
			);
