	...
	if( (isset($_POST['edit_sub'])) || (isset($_POST['add_sub'])) ){
		...
		// -- Set values
			...
			if( $type == '1' ){ // HEX
				...
				$color_rgb	= color_convert( $_POST['color_hex'], 'hex', 'rgb' );
				$color_cmyk	= color_convert( $_POST['color_hex'], 'hex', 'cmyk' );
			} else if( $type == '2' ){ // RGB
				$color_hex	= color_convert( $_POST['color_rgb'], 'rgb', 'hex' );
				$color_rgb 	= $_POST['color_rgb'];
				$color_cmyk	= color_convert( $_POST['color_rgb'], 'rgb', 'cmyk' );
			}
