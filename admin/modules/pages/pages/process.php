	...
	if( (isset($_POST['edit_sub'])) || (isset($_POST['add_sub'])) ){
		...
		// -- Set values
			...
			$values = array(
				...
				'og_image'			=> process_file( 'og_image', '/og_images/' ),
				...
				'banner_supertitle'         => $_POST['banner_supertitle'],
				'banner_button'             => $_POST['banner_button'],
				'banner_video_type'         => $_POST['banner_video_type'],
				'banner_video_file'         => process_file( 'banner_video_file', '/layout/banner/' ),
				'banner_video_url'          => $_POST['banner_video_url'],
				'banner_video_thumbnail'    => process_file( 'banner_video_thumbnail', '/layout/banner/' ),
			);
			
			if( $_POST['password'] != '' ){
				$values['password'] 	= $_POST['password'];
				$values['e_password'] 	= md5( $_POST['password'] );
			}
