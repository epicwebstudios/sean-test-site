...
<table class="table">
	...
	<tbody>
		...
		?>
            ...
            <tr <? if( $info['status'] == '2' ){ echo 'class="inactive"'; } ?>>
                ...
                <? // Column output start ?>
					...
					<td>
						...
						<?
							$url = returnURL();
							if( $info['link'] != 'home' ){ $url .= '/'.$info['link']; }
						?>
                    ...
                    <td>
                    	<? if( $info['status'] == '1' ){ ?>
                        	<b class="tc_green"><? echo $statuses[$info['status']]; ?></b>
                        <? } else { ?>
                        	<b class="tc_red"><? echo $statuses[$info['status']]; ?></b>
                        <? } ?>
                    </td>
