	...
	<table class="form">
		...
		<tbody>
			...
			<tr>
				...
				<td class="right">
                	<? field_editor( 'name', $info['name'] ); ?>
                </td>
			</tr>
			<tr>
				<td class="left">Response:</td>
				<td class="right">
                	<? field_editor( 'description', $info['description'] ); ?>
                </td>
			</tr>
			<tr>
				<td class="left">Initial State:</td>
				<td class="right">
                	<?
						$options = array( 1 => 'Collapsed', 0 => 'Open / Expanded' );
                    	field_select2( 'collapsed', $options, $info['collapsed'] );
					?>
                </td>
			</tr>
			<tr>
