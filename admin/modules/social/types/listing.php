		...
		?>
            ...
            <tr <? if( $info['status'] == '0' ){ echo 'class="inactive"'; } ?>>
                ...
                <? // Column output start ?>
					...
					<td>
						<b style="font-size:16px;"><i class="fa fa-<?= $info['icon_tag']; ?>" aria-hidden="true"></i></b>
                    </td>
                    <td>
                        <span style="font-family:monospace; font-size:12px; background-color:rgba(0,0,0,0.05)"><? echo $info['icon_unicode']; ?></span>
                    </td>
                    <td>
                        <b><? echo $info['name']; ?></b>
                    </td>
