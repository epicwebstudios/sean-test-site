		...
		?>
            ...
            <tr <? if( $info['status'] == '0' ){ echo 'class="inactive"'; } ?>>
                ...
                <? // Column output start ?>
					...
					<td>
                        <b style="font-size:16px;"><i class="fa fa-<?= $types[$info['type']]['icon_tag'] ?>" aria-hidden="true"></i></b><b><?= '&nbsp;&nbsp;&mdash;&nbsp;&nbsp;' . $types[$info['type']]['name'] ?></b>
                    </td>
                    <td>
                        <b><? echo summary($info['link'], 100); ?></b>
                    </td>
                    
                    <td>
                    	<? if( $info['status'] == '1' ){ echo '<b>Active / Enabled</b>'; } ?>
                        <? if( $info['status'] == '0' ){ echo 'Inactive / Disabled'; } ?>
                    </td>
