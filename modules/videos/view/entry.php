<?
	...
	if ( $r['video_type'] == 1 ) {
		...
		$video = '<video width="auto" height="675px" style="display: block; margin-left: auto; margin-right: auto;" preload="auto"
					controls="controls" controlslist="nodownload" data-mce-fragment="1" id="'.$r['id'].'">
