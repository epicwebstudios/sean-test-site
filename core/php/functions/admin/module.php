<?
	...
	/**
	 * Generate administrative module listing table column headings.
	 *
	 * @param array $columns Table columns, specified in module configuration.
	 * @param bool|int $allow_order Whether user has permission to reorder records.
	 * @param bool|int $allow_duplicate Whether user has permission to duplicate records.
	 * @param bool|int $allow_edit Whether user has permission to edit records.
	 * @param bool|int $allow_delete Whether user has permission to delete records.
	 * @param array $filter_list Optional. List of URL parameter keys to keep in column links. Defaults to false.
	 * @param bool|int $auto_size Optional. Whether or not to dynamically size the column. Defaults to true.
	 *
	 * @return void
	 */
	...
	/**
	 * Calculate administrative pagination values.
	 *
	 * @param string $stmt SQL statement to get record counts.
	 * @param int $page_limit The number of records to display per page.
	 *
	 * @return array Pagination calculation results.
	 */
	...
	/**
	 * Calculate administrative pagination UI.
	 *
	 * @param array $pages Generated pagination values from listing_pagination_count().
	 * @param array $search Columns to include in search, specified in module configuration.
	 * @param array $filter_list List of URL parameter keys to keep in column links.
	 * @param string $position Optional. Position of requested pagination, either 'top' or 'bottom'. Defaults to 'bottom'.
	 *
	 * @return array Pagination calculation results.
	 */
