<?
	 ...
	 *
	 * Allows you to convert from HEX, RGB
	 *
	 * @param array|string $color The HEX, RGB (array), CMYK (array) value to convert/
	 * @param string $in Format origin color is ('hex', 'rgb' or 'cmyk')
	 * @param string $out Format to convert to ('hex', 'rgb' or 'cmyk')
	 * @param array $array Optional. Return result as an array of values. Defaults to true.
	 *
	 * @return array|string Resulting conversion.
	 */
